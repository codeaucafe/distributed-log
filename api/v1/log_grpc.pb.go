...
const (
	Log_Produce_FullMethodName       = "/v1.Log/Produce"
	Log_Consume_FullMethodName       = "/v1.Log/Consume"
	Log_ConsumeStream_FullMethodName = "/v1.Log/ConsumeStream"
	Log_ProduceStream_FullMethodName = "/v1.Log/ProduceStream"
)
